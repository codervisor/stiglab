...
use onsager::{EventMetadata, EventStore};
...
impl SpineEmitter {
    ...
    pub async fn emit_session_started(
        ...
        self.emit(FactoryEventKind::SessionStarted {
    ...
    pub async fn emit_session_completed(
        ...
        self.emit(FactoryEventKind::SessionCompleted {
            session_id: session_id.to_string(),
            request_id: request_id.to_string(),
            duration_ms,
        })
    ...
    pub async fn emit_session_failed(
        ...
        self.emit(FactoryEventKind::SessionFailed {
            session_id: session_id.to_string(),
            request_id: request_id.to_string(),
